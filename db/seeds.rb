...
user = User.create(name: "Mushfi", sex: "Male", age: 24, startingWeight: 255, currentWeight: [150, 160], goalWeight: 155, macros: "protein", skillLevel: "Beginner", equipment: "Body Weight")
